...
function issuu_pdf_embeder( $atts, $content = null ) {
	...
	extract( shortcode_atts( array( 'issuu_pdf_id' => null, 'width' => $ipu_options['width'], 'height' => $ipu_options['height'], 'allowfullscreen' => ( isset( $ipu_options['allow_full_screen'] ) && $ipu_options['allow_full_screen'] == 1 ) ? 'true' : 'false' ), $atts ) ); ?>
